...
void loop() {
 ...
 stepper.step(512); // Have the motor turn through 512 steps (one revolution).
 delay(100); // Delay for .1 seconds.
 stepper.setSpeed(20); // Set the stepper speed to 20 RPM.
 stepper.step(-128); // Have the motor turn the reverse direction for 1/4 of a revolution.
 delay(100); // Delay for .1 seconds.
}
